...
namespace GithubActors_WPF.Actors
{
    ...
    public class GithubCommanderActor : ReceiveActor, IWithUnboundedStash
    {
        ...
        {
            public AbleToAcceptJob( Messages.RepoKey repo )
            {
                Repo = repo;
            }
        ...
        private Messages.RepoKey _repoJob;
        ...
        protected override void PreStart()
        {
            ...
            var props = Props.Create( () => new GithubCoordinatorActor() ).WithRouter( FromConfig.Instance );
            _coordinator = Context.ActorOf( props, ActorPaths.GithubCoordinatorActor.Name );
            base.PreStart();
        }
        ...
        private void Asking()
        {
            ...
            Receive<AbleToAcceptJob>( job =>
            {
                ...
                //launch the new window to view results 
